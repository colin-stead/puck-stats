  ...
  return (
    <div className="my-12 p-8 bg-gradient-to-br from-blue-50 to-gray-50 rounded-lg border border-gray-200">
      ...
      <div className="text-gray-700 leading-relaxed space-y-4">
        <p>
          The Hockey IQ score is built from 7 stats that each get multiplied by a weight before being added together.
        ...
        <p>
          ...
          and plus/minus per 60 chips in at 10%.
          PIM/60 negatively influences the score by 15% and xGoals Against% negatively influences the score by 10%.
        </p>
        <p>
